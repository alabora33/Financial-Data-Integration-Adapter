...
class CreditRecord(models.Model):
    ...
    insurance_included = models.CharField(max_length=1, blank=True)
...
class PaymentPlan(models.Model):
    ...
    credit = models.ForeignKey(CreditRecord, on_delete=models.CASCADE, related_name="payment_plans")
    ...
    installment_status = models.CharField(max_length=15)
